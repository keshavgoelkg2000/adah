package com.auctionhub.controller;
...
import com.auctionhub.resource.ProductResource;
...
public class ProductController {
	...
	public ResponseEntity<ProductResponseDto> fetchAllProduct(@RequestParam(name = "status") String status) {
		return this.productResource.fetchAllProducts(status);
	}

	@GetMapping("fetch/seller-wise")
	@Operation(summary = "Api to fetch all seller active product")
	public ResponseEntity<ProductResponseDto> fetchAllSellerProduct(@RequestParam(name = "sellerId") int sellerId, @RequestParam(name = "status") String status) {
		return this.productResource.fetchAllSellerProducts(sellerId, status);
	}

	@GetMapping("fetch/seller-wise/category-wise")
	@Operation(summary = "Api to fetch all seller active product")
	public ResponseEntity<ProductResponseDto> fetchAllSellerProductAndCategory(
			@RequestParam(name = "sellerId") int sellerId, @RequestParam(name = "categoryId") int categoryId, @RequestParam(name = "status") String status) {
		return this.productResource.fetchAllSellerProductsWithCategory(sellerId, categoryId, status);
	}
