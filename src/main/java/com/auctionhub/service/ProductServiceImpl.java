...
import com.auctionhub.dao.ProductDao;
...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public List<Product> findByStatusInAndEndDateBetween(List<String> status, String startTime, String endTime) {
		return this.productDao.findByStatusInAndEndDateBetween(status, startTime, endTime);
	}
